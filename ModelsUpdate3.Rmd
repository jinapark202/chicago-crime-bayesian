...
```{r}
model_4_predictor <- function(param, income, percent_nonwhite, year, population){
...
```{r}
predicted_crime_rate <- model_4_predictor(crime_data_4_sum, test_data$income, test_data$percent_white, test_data$time, test_data$total_population)
