...
Although the number of violent crimes in areas with large non-white populations are growing, the number of non-violent crimes are decreasing in these areas over time as per capita income increases. In areas with white populations greater than 20%, the number of non-violent crimes are increasing over time as per capita income increases. The bright orange areas, in particular, where the white populations are between 60-80%, face the greatest increases in the number of non-violent crimes as income rises. According to our model, all of these effects are considered significant at the 5% level.

```{r, echo=FALSE, include=FALSE, cache=TRUE, message=FALSE, warning=FALSE}
posterior_means <- crimeV_data_2[5000:nrow(crimeV_data_2),] %>% colMeans()
...
>>>>>>> 0c98fa09e8c80ea063afd8216b42917bb85900ad
