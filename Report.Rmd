...
$$\beta_i \mid \beta_0, \sigma_1, \sigma_2, \sigma_3, \tau_0 \sim N(\beta_0 + \sigma_2*income_i + \sigma_1*perwhite^{+}_i + \sigma_3*(perwhite*income)^{+}_i, \tau_0^{-1})$$
$$\delta_i \mid \delta_{i1}, \tau_1 \sim N(\delta_0, \tau_1^{-1})$$
$$\sigma_1, \sigma_2, \sigma_3 \sim N(0, \frac{1}{1000^2})$$
